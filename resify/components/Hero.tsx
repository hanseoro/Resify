    ...
    return (
        <div className="flex items-center justify-left my-60">
            <div className="text-left">
                ...
                <p className={"mt-6 text-xl text-muted " + cn.poppins}>Secure homeownership in the digital landscape</p>
                <p className={"text-xl text-muted " + cn.poppins}>to verify property online and in person.</p>
                {/* Add Button Here */}
            </div>
        </div>
    );
